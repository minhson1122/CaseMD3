                ...
                <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="urlcover" value="<c:out value="${gameN.getUrlCover()}"/>" class="form-control" id="urlcover">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Url Wallpaper</label>
                            <input type="text" name="urlwallpaper" value="<c:out value="${gameN.getUrlWallpaper()}"/>" class="form-control" id="urlwallpaper">
                        </div>
